...
let unsortedDisplay = document.getElementById("start");
unsortedDisplay.textContent = unsortedArr.join();
...
let buttonClick = document.getElementById("go");
let sortedDisplay = document.getElementById("result");
// buttonClick.addEventListener("click", unsortedArr.sort((a, b) => a - b));
// sortedDisplay.textContent = unsortedArr.join();
buttonClick.addEventListener("click", function() {
    let sortedArray = sortArray(unsortedArr);
    sortedDisplay.textContent = sortedArray.join();
})
